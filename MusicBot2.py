...
sys_loop = 1
command_prefix = os.getenv('BOT_PREFIX2')
client = discord.Client()
vcch = int(os.getenv('VCID2'))
queuech = int(os.getenv('QUEUEID2'))
...
async def on_ready():
	print('Bot Started')
	q.seteq({'options': '-vn -ac 2 -af \"firequalizer=gain_entry=\'entry(0,6);entry(2,2);entry(10,-2);entry(2500,-2);entry(6300,-4);entry(16000,10);entry(20000,10)\'\"',})
	try:
